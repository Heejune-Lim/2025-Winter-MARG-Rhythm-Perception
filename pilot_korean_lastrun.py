...
expName = 'pilot_korean'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\david\\pilot\\pilot_korean_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_5 = visual.TextStim(win=win, name='text_5',
        text='지시사항\n\n이 실험에서 피험자는 사인파로 구성된 선율과 메트로놈 음성을 듣게 됩니다. 모든 음성 자극들은 4/4박자로 되어 있으며, 이 실험의 과제는 강한 박, 즉 1박과 3박에 맞춰 스페이스 바를 누르는 것입니다. 명확한 정답은 없으므로, 피험자 본인이 첫 박과 세 번째 박이라고 생각되는 시점들에 의거하여 스페이스 바를 누르시면 됩니다. 또한, 되도록이면 스페이스 바에서 손가락을 떼지 말아주세요. \n\n지시사항을 모두 읽으셨다면 ENTER키를 눌러주세요. ',
        font='Nanum Gothic',
    ...
    text_6 = visual.TextStim(win=win, name='text_6',
        text='예시 몇 개로 연습해보겠습니다. (ENTER을 눌러 계속 진행하세요)',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_12 = visual.TextStim(win=win, name='text_12',
        text='첫 박과 세 번째 박에 스페이스 바를 눌러주세요. ',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_7 = visual.TextStim(win=win, name='text_7',
        text='또 다른 예시입니다. (ENTER를 눌러 진행하세요)',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_11 = visual.TextStim(win=win, name='text_11',
        text='연습용 예시가 다시 제시되길 원하시면 Y를, 본 실험으로 넘어가려면 N을 눌러주세요. ',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='이제 실제 실험으로 넘어가겠습니다. ENTER를 눌러 진행해주세요. ',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text = visual.TextStim(win=win, name='text',
        text='다음 시행을 실시하려면 ENTER를 눌러주세요.',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_14 = visual.TextStim(win=win, name='text_14',
        text='실험이 종료되었습니다. 참여해주셔서 감사합니다. ENTER를 눌러 퇴장해주세요. ',
        font='Nanum Gothic',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
