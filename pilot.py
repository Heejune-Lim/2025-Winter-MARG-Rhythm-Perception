...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\david\\pilot\\pilot.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_5 = visual.TextStim(win=win, name='text_5',
        text='Instructions\n\nIn this experiment, you will hear a series of sine tones and/or metronome clicks that are in 4/4 i.e. consisted of four beats per bar. The task is to press the SPACE bar on the STRONGER beats i.e. count the music as 1, 2, 3, 4 then press it on the 1s and 3s. There is no "correct" way to count the beats, so press the space bar in accordance to however you are inclined to count the music.\n\nPress ENTER when you have finished reading the instructions.',
        font='Arial',
    ...
    for thisExample in example:
        ...
        while continueRoutine:
            ...
            # Get key presses from the participant
            keys = event.getKeys()
